...
const CoursePreviewStandalone = () => {
  ...
  const goToPreviousLesson = () => {
    ...
    course.modules.forEach((module, moduleIdx) => {
      module.contents?.forEach((lesson, lessonIdx) => {
        allLessons.push({ lesson, moduleIdx, lessonIdx });
      });
    });
    ...
    if (currentIndex > 0) {
      ...
      selectLesson(prevItem.lesson, prevItem.moduleIdx, prevItem.lessonIdx);
    }
  };
  ...
  const goToNextLesson = () => {
    ...
    if (currentIndex < allLessons.length - 1) {
      ...
      selectLesson(nextItem.lesson, nextItem.moduleIdx, nextItem.lessonIdx);
    }
  };
  ...
  const handleLike = () => {
    ...
    setLiked(!liked);
    // Here you could add API call to save like/dislike
  };
  ...
  const renderContent = (lesson) => {
    ...
    switch (lesson.type) {
      ...
      case 'pdf':
        return (
          <div className="flex items-center justify-center bg-gray-50 rounded-lg" style={{ aspectRatio: '16/9' }}>
    ...
    if (loading) {
      return (
        <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#101829' }}>
      ...
      return (
        <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#101829' }}>
          <div className="text-center text-white">
            ...
            <p className="text-gray-300 mb-4">The course you're looking for doesn't exist.</p>
            <Button 
              onClick={() => window.close()}
              className="bg-white text-black hover:bg-gray-200"
            >
    ...
    return (
      <div className="min-h-screen text-white" style={{ backgroundColor: '#101829' }}>
      {/* Header */}
      <div className="border-b border-gray-700 sticky top-0 z-50" style={{ backgroundColor: '#1a2332' }}>
      ...
      <div className="flex h-[calc(100vh-73px)]">
        ...
        <div className="flex-1 flex flex-col overflow-y-auto">
          {/* Video Player */}
          <div style={{ backgroundColor: '#101829' }}>
          ...
          {currentLesson && (
            <div className="bg-gray-900 p-6 border-t border-gray-700">
              <div className="max-w-4xl mx-auto">
                <div className="mb-4">
                  <h2 className="text-xl font-semibold mb-2 text-white">{currentLesson.title}</h2>
                ...
                {currentLesson.resources && currentLesson.resources.length > 0 && (
                  <div className="mb-6">
                    <h4 className="font-semibold mb-2 text-gray-200">Resources:</h4>
                ...
                {/* Navigation and Like/Dislike Buttons */}
                <div className="flex items-center justify-between pt-4 border-t border-gray-700">
                  ...
                  <div className="flex items-center space-x-2">
                    <Button
                      ...
                      className="flex items-center space-x-2 border-gray-600 text-gray-300 hover:bg-gray-700 hover:text-gray-200 hover:border-gray-500"
                    >
        ...
        <div className={`fixed right-0 top-[73px] h-[calc(100vh-73px)] w-80 border-l border-gray-700 transform transition-transform duration-300 z-40 ${
          sidebarOpen ? 'translate-x-0' : 'translate-x-full'
        } lg:translate-x-0 lg:static lg:top-0 lg:h-full`} style={{ backgroundColor: '#1a2332' }}>
          <div className="h-full flex flex-col">
            <div className="p-4 border-b border-gray-700">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  <BookOpen className="h-5 w-5 text-gray-300" />
                  <span className="font-semibold text-gray-200">Course Content</span>
                </div>
                <Button
                  variant="ghost"
            ...
            <div className="flex-1 overflow-y-auto">
              {course.modules?.map((module, moduleIndex) => (
                <div key={module._id} className="border-b border-gray-700 last:border-b-0">
                  {/* Module Header */}
                  <div
                  ...
                  >
                    ...
                    {module.description && (
                      <p className="text-sm text-gray-400 mt-1 ml-6">{module.description}</p>
                    )}
                  </div>
...
export default CoursePreviewStandalone;
