...
/**
 * @route   POST /api/whatsapp/baileys/send
 * @desc    Send message via Baileys
 * @access  Private (Coach or Staff)
 */
router.post('/baileys/send', protect, authorizeCoach('coach', 'admin', 'staff'), whatsappController.sendBaileysMessage);
